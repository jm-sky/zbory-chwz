...
| 015 | [2026-07-09--015--mailing-lists.md](2026-07-09--015--mailing-lists.md) | Eksport adresów e-mail (filtr region/rola/grupa + kopiowanie, bez wysyłki) + przeglądarka wszystkich osób (edycja, scalanie duplikatów) | `done` |
| 016 | [2026-07-10--016--congregation-write-endpoint-for-non-admins.md](2026-07-10--016--congregation-write-endpoint-for-non-admins.md) | Pastor nie zapisze podstawowych danych zboru (endpoint admin-only) | `done` |
| 017 | [2026-07-10--017--authorization-hardening-followups.md](2026-07-10--017--authorization-hardening-followups.md) | Hardening autoryzacji — `persons/search`, `POST /tenants`, `pastors` visibility | `done` |
