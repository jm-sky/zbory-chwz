export const congregationsEn = {
  congregations: {
    ...
    completeness: {
      ...
      filterLabel: 'Completeness',
      filterAll: 'All',
      filterLow: 'Low (below 40%)',
      filterMedium: 'Medium (40–74%)',
      filterHigh: 'High (75% and up)',
      fields: {
        description: 'Description',
        street: 'Street',
        ...
        card_contacts: 'Contact persons',
        contact_email: 'Contact with an email',
        contact_phone: 'Contact with a phone',
      },
    },
  },
}
